...
import { routerv2 } from '../boaswap_address.json'
...
export const ROUTER_ADDRESS: { [key: string]: string } = {
  ...
  [ChainId.ROPSTEN]: routerv2,
  [ChainId.LUNIVERSE_TEST]: routerv2,
  [ChainId.LUNIVERSE_PROD]: routerv2,
}
...
const WDEV_ONLY: ChainTokenList = {
  ...
  [ChainId.LUNIVERSE_TEST]: [WDEV[ChainId.LUNIVERSE_TEST]],
  [ChainId.LUNIVERSE_PROD]: [WDEV[ChainId.LUNIVERSE_PROD]],
}
